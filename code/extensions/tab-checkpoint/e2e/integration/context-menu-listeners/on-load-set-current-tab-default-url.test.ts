...
/*
 * Functional Test: Set Current Tab Checkpoint via Context Menu
 */

test.describe('Context Menu - Set Current Tab Checkpoint', () => {
  let page: Page;
  ...
  test('should verify context-menu-set-current-tab-checkpoint listener is registered', async ({ context }) => {
    ...
    await expect.poll(async () => {
      return await background.evaluate(async () => {
        return await new Promise<boolean>((resolve) => {
          const menuItemId = 'context-menu-set-current-tab-checkpoint';

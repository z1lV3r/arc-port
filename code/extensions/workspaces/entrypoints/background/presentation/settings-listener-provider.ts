import { SettingsEventListenersDependencyProvider as AppDependencyProvider } from "@/app/dependency-provider/presentation/settings-event-listeners-dependency-provider";
